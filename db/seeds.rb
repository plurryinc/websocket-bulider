...
Echo.create(query: '{"cmd": 10}', response: '{"rs": 110, "amount": 2, "errcode": 0}')
Echo.create(query: '{"cmd": 8, speed: 255}', response: '{"rs": 109, speed: 255, "errcode": 0}')
Echo.create(query: '{"cmd": 8, speed: 10}', response: '{"rs": 108, speed: 255, "errcode": 0}')
Echo.create(query: '{"cmd": 7}', response: '{"rs": 107, "amount": 2, "errcode": 0}')
Echo.create(query: '{"cmd": 6, "amount": 5}', response: '{"rs": 106, "amount": 3, "errcode": 0}')
Echo.create(query: '{"rs": 105, "count": 5, "errcode": 0}', response: '{"rs": 105, "count": 5, "errcode": 0}')
